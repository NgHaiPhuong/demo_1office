...
class CompLeaveInfoTab extends StatefulWidget {
  const CompLeaveInfoTab({super.key});

  @override
  State<CompLeaveInfoTab> createState() => _CompLeaveInfoTab();
}

class _CompLeaveInfoTab extends State<CompLeaveInfoTab> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          _leaveInfo("Thông tin nghỉ bù năm", 0),
          SizedBox(height: 18),
          _leaveInfo("Thông tin nghỉ bù tháng", 1),
          SizedBox(height: 18),
