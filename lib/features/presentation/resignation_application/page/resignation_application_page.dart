...
class ResignationApplicationPage extends StatelessWidget {
  const ResignationApplicationPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            HomeHeader(userName: 'Tạo mới đơn xin thôi việc',showBackButton: true,),
