...
class ReasonCheckInOutPage extends StatefulWidget {
  const ReasonCheckInOutPage({super.key});

  @override
  State<ReasonCheckInOutPage> createState() => _ReasonCheckInOutPageState();
}

class _ReasonCheckInOutPageState extends State<ReasonCheckInOutPage> {
  ...
  List<Widget> _buildReasonList() {
    final reasons = [
      {'title': 'Quên chốt vân tay', 'limit': '1 Lần / Tuần'},
    ];
