...
class PlaceTimekeepingPage extends StatefulWidget {
  const PlaceTimekeepingPage({super.key});

  @override
  State<PlaceTimekeepingPage> createState() => _PlaceTimekeepingPageState();
}

class _PlaceTimekeepingPageState extends State<PlaceTimekeepingPage> {
  ...
  Widget _buildTitle(){
    return Container(
      ...
      child: Row(
        children: [
          Text('Địa điểm chấm công',style: TextStyle(fontSize: 20,color: Colors.white),),
